...
You can use [MiniHost Modular](https://forum.image-line.com/viewtopic.php?f=1919&t=123031) my direct [gDrive](https://drive.google.com/drive/folders/1TOBFNVziPWlAZdfsVFBB7751qfIr82AN?usp=drive_link) link(You might need to run installer exe from run as administrator cmd)on Windows and Mac to route vsts with different midi ch assigned
